    ...
    return (
        <>
            {isShow && <div
                ...
                <div className="flex flex-col md:flex-row md:justify-center md:items-center justify-start items-start md:gap-[5px] gap-0 text-lg mt-[14px] ml-[17px] md:my-0 md:mx-0">
                ...
                <span onClick={closeBanner} className="block cursor-pointer absolute right-[23px] md:top-1/2 top-[20px] md:-translate-y-[50%]"><CloseIcon
